...
export function DashboardPage() {
  ...
  function addAccount(accountName) {
    dispatch({
      ...
      payload: { id: crypto.randomUUID(), name: accountName, type: 'bank' },
    });
  }
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 p-4 md:p-8">
      ...
      <MonthlySummaryCards spent={monthlySpent} earned={monthlyEarned} currency={defaultCurrency} />

      <section className="grid gap-4 lg:grid-cols-3">
        <div className="space-y-4 lg:col-span-2">
          <RecentTransactions groups={recentTransactionGroups} categories={state.categories} defaultCurrency={defaultCurrency} />
          <TransactionForm
        ...
        <div className="space-y-4">
          <SpendingByCategoryChart data={spendingByCategory} spent={monthlySpent} defaultCurrency={defaultCurrency} />
      ...
      <section className="grid gap-4 lg:grid-cols-3">
        ...
        <RecurringTransactionsPanel
          ...
          accounts={state.accounts}
          defaultCurrency={defaultCurrency}
          onApplyDue={() => dispatch({ type: financeActions.applyRecurringDue })}
